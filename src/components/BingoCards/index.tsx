...
export default function BingoCards(clerkId: any) {
            ...
            navigator.clipboard
              ...
              .then(() => {
                ...
                toast({
                  ...
                  description:
                    "You can now paste the image into an email or document",
                  variant: "success",
                });
              })
              .catch((err) => {
  ...
  if (isLoading)
    return (
      <div className={styles.container}>
        <div className="h-12 w-12 animate-spin rounded-full border-b-4 border-t-4 border-slate-700"></div>
      </div>
    );
  ...
  if (!data)
    return (
      <>
        <div className={styles.container}>
          <p className="text-3xl font-medium">Welcome new player!</p>
          <p className="text-xl font-light text-slate-400">
            To start the game press the button and generate bingo.
          </p>
